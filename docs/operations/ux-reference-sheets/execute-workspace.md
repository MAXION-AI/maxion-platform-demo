...
| Interactivity floor | Composer in context; every state actionable; live state; no dead ends. | Static-report test passes for 7 declared states | Walk the flow and act on each state |
