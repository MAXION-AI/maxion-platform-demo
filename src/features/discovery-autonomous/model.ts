...
export const SCENARIOS: Record<ScenarioKey, Scenario> = {
	...
	enterprise: {
		...
		match: ["servicenow", "service now", "snow", "financial control", "financial controls", "controls platform", "sox", "journal", "reconciliation", "period close", "month-end", "segregation of duties", "change approval", "finance operations", "workday", "erp"],
...
// shorter ones so "financial controls" beats an incidental "vendor".
export function scenarioForBrief(brief: string, fallback: ScenarioKey = "tprm"): ScenarioKey {
