...
describe("MaxionPlatformPrototypePage", () => {
	...
	it("creates an autonomous Plan from existing context and provides L2, L3, and L4 guidance for every flow", () => {
		...
		expect(screen.getByRole("heading", { name: "From solution intent to team-ready build contracts." })).toBeInTheDocument()
		...
		const l2Diagram = screen.getByRole("img", { name: "L2 diagram for ServiceNow to Workday financial integration" })
		...
		const l3Diagram = screen.getByRole("img", { name: "L3 diagram for ServiceNow to Workday financial integration" })
		...
		const l4Diagram = screen.getByRole("img", { name: "L4 diagram for ServiceNow to Workday financial integration" })
