...
function PlanApprovalView({ approved, onApprove }: { approved: boolean; onApprove: () => void }) {
	const requests = [
		...
		{ id: "program", initials: "MC", name: "Maya Chen", role: "Program owner", scope: "Authorize Execute to build the approved L3 and L4 scope", basis: "Mission authority record · D-14", channel: "Teams + email · delivered 14:21", status: approved ? "Approved" : "Decision needed" },
	] as const
